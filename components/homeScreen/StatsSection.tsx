...
const stats = [
  { value: "250+", key: "projectsCompleted" as const, color: "#3b82f6" },
  { value: "99%", key: "clientSatisfaction" as const, color: "#14b8a6" },
  { value: "99.9%", key: "systemUptime" as const, color: "#22c55e" },
  { value: "85", key: "globalPartners" as const, color: "#f97316" },
] as const;
